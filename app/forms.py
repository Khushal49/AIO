...
class CustomerRegistrationForm(UserCreationForm):
    ...
    DOB = forms.DateField(required=True,widget=forms.DateInput(attrs={'class':'form-control'}))
    
    class Meta:
        model = User
        fields = ['username','email','password1','password2','mobile','DOB']
        labels = {'email':'Email','mobile':'Mobile','DOB':'Date Of Birth'}
