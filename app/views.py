...
def homeessen(request,data=None):
 if data == None:
     mohomeessenbiles = Product.objects.filter(category='HE')
 elif data == 'Brush' or data == 'Mixture' or data == 'Padade':
     homeessen = Product.objects.filter(category='HE').filter(brand=data)
 elif data == 'below':
     homeessen = Product.objects.filter(category='HE').filter(discounted_price__lt=10000)
 elif data == 'above':
     homeessen = Product.objects.filter(category='HE').filter(discounted_price__gt=10000)

 return render(request, 'app/homeessen.html',{'homeessen':homeessen})
...
def checkout(request):
    ...
    print(response,"Order Success")
    
    # send_mail(
    #     "Subject here",
    #     "Here is the message.",
    #     "khushaldharat98@gmail.com",
    #     ["khushaldharat4kd@gmail.com"],
    #     fail_silently=False,
    # )
...
def paymemt_done(request):
    ...
    for c in cart:
        ...
        c.delete()
    return render("app/orderconfirm.html/")
